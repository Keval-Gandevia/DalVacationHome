...
export default function CustomerChatBot() {
  ...
  const predefinedPrompts = ["Room Details", "How to see the rooms", "Where is the dashboard", "Want to talk to Property Owner"];
    ...
    <div className=" fixed -bottom-1 right-1 max-w-xs w-full px-4 pb-4 border rounded-lg bg-gray-100 shadow-lg">
      <div className={" flex justify-evenly "}>
        ...
        <div className=" p-4">
          ...
          >
            {toggleConcern ? "  Close Property Owner Chat" : " Open  Property Owner Chat"}
          </button>
        </div>
      </div>
